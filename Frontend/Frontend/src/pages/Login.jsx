    ...
    <div className="min-h-screen bg-[#F8FAFC] flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-md animate-fade-in">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-6 sm:p-8 border border-[#E5E7EB] transform hover:shadow-2xl transition-all duration-300">
          <h1 className="text-2xl sm:text-3xl font-bold text-[#111827] mb-2">Sign in</h1>
          <p className="text-gray-600 mb-6 text-sm sm:text-base">Please login to continue</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="text-left animate-slide-up" style={{ animationDelay: '0.3s' }}>
            ...
            {/* Don't have account */}
            <div className="text-center text-gray-600 text-sm sm:text-base animate-slide-up" style={{ animationDelay: '0.5s' }}>
